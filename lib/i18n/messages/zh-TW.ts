...
"sidebar.reviewChanges": "變更（{count} 個檔案）",
    ...
    "memory.subtitle": "跨工作階段保存的長期筆記：記什麼、什麼時候自動記、已經記了哪些。",
    "memory.switches": "開關",
    "memory.enable": "啟用記憶",
    "memory.enableHint": "預設關閉。關閉期間不注入任何提示詞內容，remember / recall 工具也會拒絕執行。",
    "memory.autoLearn": "每輪結束後自動學習",
    "memory.autoLearnHint": "每次正常跑完後額外執行一次「捕獲回合」，把值得長期保留的事寫下來。實驗性功能，會額外消耗 token。",
    "memory.statusOn": "記憶已開啟",
    "memory.statusOff": "記憶已關閉 —— AI 既不讀也不寫筆記",
    "memory.statusAuto": "自動學習開",
    "memory.statusManual": "僅手動",
    ...
    "mcp.scopeProject": "專案",
    "mcp.scopeGlobal": "使用者",
    "memory.maintenance": "維護",
    "memory.stats": "{total} 則 · 全域 {global} · {projectCount} 個專案 · {characters} 字",
    "memory.statsSources": "你寫了 {user} 則 · AI 寫了 {agent} 則",
    "memory.consolidate": "整理合併",
    "memory.consolidateHint": "去除前後空白、合併說法相同的條目。純本地確定性處理，不呼叫模型。",
    "memory.consolidated": "合併掉 {count} 則重複",
    "memory.clearAll": "全部清空",
    "memory.clearConfirm": "刪除所有已儲存的記憶？",
    "memory.cleared": "已刪除 {count} 則",
    "memory.export": "匯出 MEMORY.md",
    "memory.exportDone": "已寫入 {path}",
    "memory.preview": "實際注入的內容",
    "memory.title": "記憶",
    "memory.add": "新增一則記憶",
    "memory.placeholder": "這個倉庫用 pnpm 不用 npm；測試跟原始碼放一起。",
    "memory.scope": "作用範圍",
    "memory.scopeGlobal": "所有專案",
    "memory.scopeProject": "目前專案",
    "memory.save": "儲存",
    "memory.saved": "已儲存 · {count}",
    "memory.loading": "載入中…",
    "memory.empty": "還沒有記憶。你請它記住某件事時，筆記會出現在這裡。",
    "memory.edit": "編輯",
    "memory.delete": "刪除這則記憶",
    "memory.source.user": "你",
    "memory.source.agent": "AI",
    "memory.hint": "記憶會自動注入到該範圍內的每個工作階段，AI 也能用 remember / recall 工具讀寫。",
