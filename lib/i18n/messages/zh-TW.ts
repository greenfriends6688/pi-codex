...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "mcp.title": "MCP 伺服器",
    "mcp.refresh": "重新整理",
    "mcp.noCwd": "開啟或建立工作階段以管理 MCP 伺服器。",
    "mcp.loading": "正在載入 MCP 伺服器…",
    "mcp.empty": "尚未設定 MCP 伺服器。請在全域設定中新增，或在終端機執行 /mcp setup。",
    "mcp.adapterMissing": "此工作階段未偵測到 pi-mcp-adapter 擴充功能，因此未載入 MCP 工具。",
    "mcp.enabledCount": "已啟用 {enabled}/{total}",
    "mcp.sourceProject": "專案",
    "mcp.sourceGlobal": "全域",
    "mcp.overridden": "（覆寫）",
    "mcp.status.disabled": "已停用",
    "mcp.status.active": "執行中",
    "mcp.status.inactive": "已載入但未啟用",
    "mcp.status.not-loaded": "已啟用但未載入",
    "mcp.toolsActive": "{count} 個工具執行中",
    "mcp.toolsInactive": "已載入 {count} 個工具，但在本次工作階段中未啟用",
    "mcp.reconnect": "重新連線",
    "mcp.reconnectNoSession": "請先啟動工作階段再重新連線",
    "mcp.enable": "啟用",
    "mcp.disable": "停用",
    "mcp.busyHint": "工作階段忙碌中；待其閒置並重新載入後生效。",
    "mcp.paths": "專案：{project} · 全域：{global}",
    "session.info": "工作階段資訊",
    "session.name": "名稱",
    "session.file": "工作階段檔案",
