...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.piTheme": "pi 主题",
"settings.piThemeHint": "直接读取 pi CLI 主题文件（~/.pi/agent/themes），你自己的主题优先于内置。",
    "settings.wallpaper": "壁纸",
    "settings.wallpaperDescription": "在工作区后面放一张图片。用主题自己的背景色做遮罩，保证六套色板的文字对比度都不受影响。",
    "settings.wallpaperChoose": "选择图片",
    "settings.wallpaperReplace": "更换图片",
    "settings.wallpaperRemove": "移除",
    "settings.wallpaperUseBuiltin": "改用内置",
    "settings.wallpaperBuiltinNote": "未选择图片，当前使用与色板配套的内置壁纸。",
    "settings.wallpaperBuiltinActive": "正在显示与当前色板配套的内置壁纸。",
    ...
    "settings.piThemeDescription": "直接读取 pi CLI 主题文件，让网页与终端观感一致。`~/.pi/agent/themes` 与 `<项目>/.pi/themes` 中的用户主题优先于内置主题。",
"settings.piThemeNone": "不使用",
    "settings.piThemeBundled": "内置",
    "settings.piThemeLocal": "本地",
    "settings.piThemeEmpty": "未找到 pi 主题。",
    "settings.piThemeLoading": "加载中…",
    "settings.piThemeLoadFailed": "加载 pi 主题失败。",
