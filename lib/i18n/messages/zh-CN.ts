...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "mcp.title": "MCP 服务器",
    "mcp.refresh": "刷新",
    "mcp.noCwd": "打开或新建会话以管理 MCP 服务器。",
    "mcp.loading": "正在加载 MCP 服务器…",
    "mcp.empty": "尚未配置 MCP 服务器。请在全局配置中添加，或在终端运行 /mcp setup。",
    "mcp.adapterMissing": "此会话未检测到 pi-mcp-adapter 扩展，因此未加载 MCP 工具。",
    "mcp.enabledCount": "已启用 {enabled}/{total}",
    "mcp.sourceProject": "项目",
    "mcp.sourceGlobal": "全局",
    "mcp.overridden": "（覆盖）",
    "mcp.status.disabled": "已禁用",
    "mcp.status.active": "运行中",
    "mcp.status.inactive": "已加载但未激活",
    "mcp.status.not-loaded": "已启用但未加载",
    "mcp.toolsActive": "{count} 个工具运行中",
    "mcp.toolsInactive": "已加载 {count} 个工具，但在本次会话中未激活",
    "mcp.reconnect": "重连",
    "mcp.reconnectNoSession": "请先启动会话再重连",
    "mcp.enable": "启用",
    "mcp.disable": "禁用",
    "mcp.busyHint": "会话正忙；待其空闲并重载后生效。",
    "mcp.paths": "项目：{project} · 全局：{global}",
    "session.info": "会话信息",
    "session.name": "名称",
    "session.file": "会话文件",
