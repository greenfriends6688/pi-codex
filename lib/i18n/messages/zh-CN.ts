...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.generalDescription": "选择 Pi Agent 的显示方式和界面语言。",
    ...
    "agents.close": "关闭",
    "agents.builtInTitle": "启用 Pi Agent 内置子代理",
    "agents.builtInDescription": "提供 Pi Agent 集成的 Agent 工具，并停用发生冲突的 pi-subagents 扩展。",
    ...
    "appUpdate.releaseNotes": "Pi Agent v{version} 可用，查看更新说明",
    "sidebar.hide": "隐藏侧边栏",
    "sidebar.show": "显示侧边栏",
    "theme.light": "主题：浅色",
    "theme.dark": "主题：深色",
    ...
    "sidebar.openInExplorerRemoteOnly": "仅在 Pi Agent 运行在本机时可用",
