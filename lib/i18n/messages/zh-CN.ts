...
"sidebar.reviewChanges": "变更（{count} 个文件）",
    ...
    "memory.subtitle": "跨会话保存的长期笔记：记什么、什么时候自动记、已经记了哪些。",
    "memory.switches": "开关",
    "memory.enable": "启用记忆",
    "memory.enableHint": "默认关闭。关闭期间不向提示词注入任何内容，remember / recall 工具也会拒绝执行。",
    "memory.autoLearn": "每轮结束后自动学习",
    "memory.autoLearnHint": "每次正常跑完后额外执行一次「捕获回合」，把值得长期保留的事写下来。实验性功能，会额外消耗 token。",
    "memory.statusOn": "记忆已开启",
    "memory.statusOff": "记忆已关闭 —— AI 既不读也不写笔记",
    "memory.statusAuto": "自动学习开",
    "memory.statusManual": "仅手动",
    ...
    "mcp.scopeProject": "项目",
    "mcp.scopeGlobal": "用户",
    "memory.maintenance": "维护",
    "memory.stats": "{total} 条 · 全局 {global} · {projectCount} 个项目 · {characters} 字",
    "memory.statsSources": "你写了 {user} 条 · AI 写了 {agent} 条",
    "memory.consolidate": "整理合并",
    "memory.consolidateHint": "去掉首尾空白、合并说法相同的条目。纯本地确定性处理，不调用模型。",
    "memory.consolidated": "合并掉 {count} 条重复",
    "memory.clearAll": "全部清空",
    "memory.clearConfirm": "删除所有已保存的记忆？",
    "memory.cleared": "已删除 {count} 条",
    "memory.export": "导出 MEMORY.md",
    "memory.exportDone": "已写入 {path}",
    "memory.preview": "实际注入的内容",
    "memory.title": "记忆",
    "memory.add": "添加一条记忆",
    "memory.placeholder": "这个仓库用 pnpm 不用 npm；测试跟源码放一起。",
    "memory.scope": "作用范围",
    "memory.scopeGlobal": "所有项目",
    "memory.scopeProject": "当前项目",
    "memory.save": "保存",
    "memory.saved": "已保存 · {count}",
    "memory.loading": "加载中…",
    "memory.empty": "还没有记忆。你让它记住某件事时，笔记会出现在这里。",
    "memory.edit": "编辑",
    "memory.delete": "删除这条记忆",
    "memory.source.user": "你",
    "memory.source.agent": "AI",
    "memory.hint": "记忆会自动注入到该范围内的每个会话，AI 也能用 remember / recall 工具读写。",
