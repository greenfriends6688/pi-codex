...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.piTheme": "pi theme",
"settings.piThemeHint": "Reads pi CLI theme files (~/.pi/agent/themes). Your own themes take precedence over the bundled ones.",
    "settings.wallpaper": "Wallpaper",
    "settings.wallpaperDescription": "Puts an image behind the workspace. Text contrast is preserved by dimming it with the theme's own background colour, so every palette stays readable.",
    ...
    "settings.wallpaperBuiltinNote": "No image chosen — the built-in painting for the active palette is used.",
    "settings.wallpaperBuiltinActive": "Showing the built-in painting for this palette.",
    ...
    "settings.piThemeDescription": "Reads pi CLI theme files so the web UI matches your terminal. User themes in ~/.pi/agent/themes and <project>/.pi/themes take precedence over the bundled ones.",
"settings.piThemeNone": "Not used",
    "settings.piThemeBundled": "Bundled",
    "settings.piThemeLocal": "From disk",
    "settings.piThemeEmpty": "No pi themes found.",
    "settings.piThemeLoading": "Loading…",
    "settings.piThemeLoadFailed": "Could not load pi themes.",
