...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "mcp.refresh": "Refresh",
    "mcp.noCwd": "Open or start a session to manage MCP servers.",
    "mcp.loading": "Loading MCP servers…",
    "mcp.empty": "No MCP servers configured. Add some to the global config, or run /mcp setup in the terminal.",
    "mcp.adapterMissing": "The pi-mcp-adapter extension was not detected in this session, so no MCP tools are loaded.",
    "mcp.enabledCount": "{enabled} of {total} enabled",
    "mcp.sourceProject": "project",
    "mcp.sourceGlobal": "global",
    "mcp.overridden": " (override)",
    "mcp.status.disabled": "Disabled",
    "mcp.status.active": "Active",
    "mcp.status.inactive": "Loaded but inactive",
    "mcp.status.not-loaded": "Enabled, not loaded",
    "mcp.toolsActive": "{count} tools active",
    "mcp.toolsInactive": "{count} tools loaded but inactive in this session",
    "mcp.reconnect": "Reconnect",
    "mcp.reconnectNoSession": "Start the session to reconnect",
    "mcp.enable": "Enable",
    "mcp.disable": "Disable",
    "mcp.busyHint": "The session is busy; changes apply after it goes idle and reloads.",
    "mcp.paths": "Project: {project} · Global: {global}",
