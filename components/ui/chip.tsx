// fork:ds-small-parts（DS-07/DS-08）—— 状态/角色标签：9 色 × bold / subtle / caption 三档强调。
// 来源：BoardUI components/base/badges/chip.tsx（MIT）。改动：无（仅补 motion-reduce:transition-none）。
...
const styles = sortCx({
  base: "inline-flex items-center justify-center rounded-md px-1.5 whitespace-nowrap transition-[padding,font-size] duration-200 ease motion-reduce:transition-none",
  variant: {
