...
- **プロジェクトファイルツール**：ファイルの閲覧とアップロード、テキストファイルのその場編集、ファイルやフォルダの作成・名前変更・削除、ファイルのダウンロード、ZIP アーカイブの展開と作成、Git Diff の確認、ソース、Markdown、画像、音声、PDF、DOCX のプレビューに対応し、変更時は自動更新されます。
