...
- **Инструменты для файлов проекта**: просмотр и загрузка файлов, редактирование текстовых файлов на месте, создание, переименование и удаление файлов и папок, скачивание файлов, распаковка и создание ZIP-архивов, проверка Git Diff, предпросмотр исходного кода, Markdown, изображений, аудио, PDF и DOCX с автоматическим обновлением.
